...
// X-Ways Software Technology AG, 2004-2023
...
begin
	...
	uint16	"Group ID for reserved blocks"
		...
		move -4
		uint_flex "3" "Supports EA"
		move -4
		uint_flex "4" "Has reserved GDT"
		move -4
		uint_flex "9" "Sparse Super v2"
		move -4
		hex 4	All

		section "Incompatibility Feature Flags"
		uint_flex "0" "Supports compression"
		move -4
		uint_flex "1" "Filetype in dir. entry"
		move -4
		uint_flex "2" "FS needs recovery"
		move -4
		...
		move -4
		uint_flex "1" "Files>2GB supported"
		move -4
		uint_flex "3" "Gigantic files supported"
		move -4
		uint_flex "4" "GDT checksums"
		move -4
		uint_flex "5" ">32k subdirs allowed"
		move -4
		uint_flex "6" "Large inodes in use"
		move -4

		uint_flex "10" "Metadata CSUMs"
		move -4
		uint_flex "12" "FS is read-only"
		move -4
